/*Write a C program to read n numbers from the user and sort them 
in ascending/ descending order using Merge Sort method. Use arrays 
to store numbers and display it. (use functions)*/
#include <stdio.h>
