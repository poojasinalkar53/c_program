/*
1) Write a C program to implement a singly linked list. The
program should be menu driven with the following options: 1.create 2.insert 
3.display 4. Search  5.delete(by value ) 6.delete(by position).
*/
#include<stdio.h>
void create();
void insert();
...
int main()
{
    printf("Program to create the link list \n");
    int choice;
    loop:
    {
